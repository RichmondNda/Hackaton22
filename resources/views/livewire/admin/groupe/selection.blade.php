                                                ...
                                                <div class="text-sm font-bold  flex text-gray-900 text-md">
                                                    @if($equipe->statut == true)
                                                        ...
                                                        <form action="{{route('selection.sendmail', null, false)}}" method="POST">
                                                            ...
                                                            <button 
                                                                type="submit"
                                                                class="px-2 py-1 mx-4 text-sm font-bold flex text-orange uppercase transition-all duration-150 rounded shadow outline-none ease-linearbg-emerald-500  hover:shadow-lg focus:outline-none" type="submit">
                                        ...
                                        <div class="flex">
                                            ...
                                            @if($equipe->statut == true)
                                                <button 
                                                    ...
                                                    class="px-2 py-1 text-sm font-bold flex text-red-700 uppercase transition-all duration-150 rounded shadow outline-none ease-linearbg-emerald-500  hover:shadow-lg focus:outline-none" type="submit">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
