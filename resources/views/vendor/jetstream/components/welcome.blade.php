<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    <div>
        <x-jet-application-logo class="block h-24 w-48" />
    </div>
    ...
    <div class="mt-6 text-gray-500">
        ...
        @if(Auth::user()->etudiant)
            ...
            <br/>
            @if (Auth::user()->etudiant->currentEquipe())

                <span class="font-bold text-green-600 text-xl"> Felicitation Vôtre Equipe est sélectionnée</span>

            @else

                <span class="font-bold text-red-600 text-xl"> Dommage La prochaine fois sera la bonne</span>
